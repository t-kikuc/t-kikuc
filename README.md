...
| ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ----- | --------------------------------------------------------------------------------- |
| 2025-01-17 | [ecspresso, ecschedule, lambroll を PipeCDプラグインとして動かしてみた （プロトタイプ）　](https://speakerdeck.com/tkikuc/running-ecspresso-ecschedule-and-lambroll-as-pipecd-plugins-prototype) | ecspresso, PipeCD | 5min | [Fujiwara Tech Conference 2025](https://connpass.com/event/338668/) LT |
